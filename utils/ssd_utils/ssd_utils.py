...
from utils.ssd_utils.augment import DiffAug
...
class SummarizeUpdate(object):
    ...
    def new_task(self, num_classes, labels):
        ...
        '''
        if self.params.dataset == 'mini_imagenet':
            im_size = (84, 84)
        elif self.params.dataset == 'tiny_imagenet':
            im_size = (64, 64)
        elif self.params.dataset == 'etc_cil':
            im_size = (20,256)
        else:
            im_size = (32, 32)
        self.model = ETC_CNN(num_classes).cuda()
    ...
    def update(self, buffer, x, y, aff_x=None, aff_y=None, update_index=-1, transform=None, **kwargs):
        ...
        for data, label in zip(x, y):
            ...
            if self.params.memory_size > buffer.current_index:
            ...
            # The buffer is full
                ...
                # The condense dict is full -> original reservoir update
                    ...
                    if random_index < self.params.memory_size and random_index in buffer.avail_indices:
